...
class FrameFields(enum.Enum):
	...
	wlan_ta = 'wlan.ta'
	wlan_ra = 'wlan.ra'
	wlan_mgt_fixed_status_code = 'wlan_mgt.fixed.status_code'  # required only for assigning rbs tags
	wlan_mgt_ssid = 'wlan_mgt.ssid'
	wlan_fc_subtype = 'wlan.fc.type_subtype'
