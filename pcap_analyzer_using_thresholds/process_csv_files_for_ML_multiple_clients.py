...
class EpisodeFeatures(enum.Enum):
	rssi__mean = 'ssi.mean'
	rssi__sd = 'ssi.sd'
	frame__loss_rate = 'frame.lossrate'
	frame__frequency = 'frames.persec'
	ap_deauth__count = 'ap.deauth.count'
	client_deauth__count = 'client.deauth.count'
	beacon__count = 'beacon.count'
	max_consecutive_beacons__count = 'beacon.interval'
	ack__count = 'ack.count'
	null_dataframe__count = 'ndf.count'
	failure_assoc__count = 'failure.assoc.count'
	success_assoc__count = 'success.assoc.count'
	class_3_frames__count = 'class3frames.count'


class EpisodeProperties(enum.Enum):
	start__time_epoch = 'start.time'
	end__time_epoch = 'end.time'
	episode_duration = 'duration.time'
